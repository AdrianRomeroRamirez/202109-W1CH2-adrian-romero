...
function mostrarDatos(element, index, array) {
    ...
    console.log("El vuelo con origen: " + element.from + " y destino: " + element.to + ", tiene un coste de " + element.cost + "€ y" + (element.scale ? " si tiene escala." : " no hay escala."));
...
function admin() {
    ...
    do {
        ...
        if (accionAdmin === "CREAR") {
            ...
            let newFlight = { id: idN, to: toN, from: fromN, cost: costN, scale: boolValue };
...
function user() {
    ...
    do {
        ...
        accionUser = prompt("Que quieres buscar? Más alto, más bajo o igual? (alto/bajo/igual)");
        ...
        alert("Vuelo con id: " + idVuelo + " a sido reservado. Gracias por su compra, vuelva pronto.");



    } while (accionUser !== "ALTO" && accionUser !== "BAJO" && accionUser !== "IGUAL")
